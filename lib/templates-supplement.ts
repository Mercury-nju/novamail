...
export const supplementTemplates: ProfessionalTemplate[] = [
...

  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Appointment Reminder</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#fffbeb"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(251,191,36,0.2)"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#f59e0b,#d97706);text-align:center"><div style="font-size:64px;margin-bottom:20px">⏰</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">Appointment Reminder</h1><p style="color:#fed7aa;margin:10px 0 0;font-size:18px">Don't forget your appointment</p></div></td></tr><tr><td style="padding:50px 40px"><p style="color:#1f2937;margin:0 0 30px;font-size:18px;font-weight:600;text-align:center">Friendly reminder about your upcoming appointment</p><div style="background:#fffbeb;padding:35px;border-radius:12px;border:2px solid #fed7aa;margin:30px 0"><div style="text-align:center"><div style="font-size:48px;margin-bottom:15px">📅</div><p style="margin:0 0 10px;color:#92400e;font-weight:700;font-size:20px">Tomorrow at 2:00 PM</p><p style="margin:0;color:#78350f;font-size:16px">March 21, 2024</p></div></div><div style="background:#f9fafb;padding:25px;border-radius:8px;margin:25px 0"><p style="margin:0 0 15px;color:#1f2937;font-weight:700">Appointment Details:</p><ul style="margin:0;padding-left:22px;color:#6b7280"><li>Duration: 60 minutes</li><li>Location: Office Suite 201</li><li>Please arrive 10 minutes early</li><li>Contact us if you need to reschedule</li></ul></div><p style="color:#6b7280;margin:0 0 30px;line-height:1.7;text-align:center">We're looking forward to seeing you tomorrow!</p><div style="text-align:center;margin-top:40px"><a href="#" style="background:linear-gradient(135deg,#f59e0b,#d97706);color:#fff;text-decoration:none;padding:20px 60px;border-radius:12px;font-weight:900;font-size:20px;display:inline-block;box-shadow:0 8px 20px rgba(245,158,11,0.4)">View Details →</a></div></td></tr></table></body></html>`,
...

  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Item Available</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#f0fdf4"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(34,197,94,0.2);border:2px solid #86efac"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#10b981,#059669);text-align:center"><div style="font-size:64px;margin-bottom:20px">🎉</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">Available Now!</h1><p style="color:#d1fae5;margin:10px 0 0;font-size:18px">Item from your waitlist is back</p></div></td></tr><tr><td style="padding:50px 40px"><p style="color:#1f2937;margin:0 0 30px;font-size:18px;font-weight:600;text-align:center">Great news! The item you wanted is now available</p><div style="background:#f0fdf4;padding:30px;border-radius:12px;margin:30px 0"><p style="margin:0 0 20px;color:#059669;font-weight:700;text-align:center;font-size:20px">Premium Product</p><p style="margin:0;color:#6b7280;text-align:center">The product you added to your waitlist is now in stock and ready for purchase.</p></div><div style="background:#d1fae5;padding:25px;border-radius:8px;margin:25px 0"><p style="margin:0;color:#065f46;font-weight:700;text-align:center">⚠️ Limited Stock - Act fast before it sells out again!</p></div><p style="color:#6b7280;margin:0 0 30px;line-height:1.7;text-align:center">Hurry and complete your purchase while stocks last.</p><div style="text-align:center;margin-top:40px"><a href="#" style="background:linear-gradient(135deg,#10b981,#059669);color:#fff;text-decoration:none;padding:20px 60px;border-radius:12px;font-weight:900;font-size:20px;display:inline-block;box-shadow:0 8px 20px rgba(16,185,129,0.4)">Shop Now →</a></div></td></tr></table></body></html>`,
...

  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Back in Stock</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#f0fdf4"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(34,197,94,0.2)"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#16a34a,#059669);text-align:center"><div style="font-size:64px;margin-bottom:20px">✅</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">Back in Stock!</h1><p style="color:#d1fae5;margin:10px 0 0;font-size:18px">Previously sold out item is available</p></div></td></tr><tr><td style="padding:50px 40px"><p style="color:#1f2937;margin:0 0 30px;font-size:18px;font-weight:600;text-align:center">Good news! The item is now back in stock</p><div style="background:#f0fdf4;padding:30px;border-radius:12px;margin:30px 0"><p style="margin:0 0 20px;color:#059669;font-weight:700;text-align:center;font-size:20px">📦 Product Status</p><p style="margin:0;color:#6b7280;text-align:center">The previously sold out item is now back in stock and ready for immediate purchase.</p></div><div style="background:#d1fae5;padding:20px;border-radius:8px;margin:25px 0"><p style="margin:0;color:#065f46;font-size:14px;text-align:center">⚡ Limited quantities available - Shop now before it sells out again!</p></div><p style="color:#6b7280;margin:0 0 30px;line-height:1.7;text-align:center">Don't miss out this time - secure your item while supplies last.</p><div style="text-align:center;margin-top:40px"><a href="#" style="background:linear-gradient(135deg,#16a34a,#059669);color:#fff;text-decoration:none;padding:20px 60px;border-radius:12px;font-weight:900;font-size:20px;display:inline-block;box-shadow:0 8px 20px rgba(22,163,74,0.4)">Shop Now →</a></div></td></tr></table></body></html>`,
...

  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Price Drop Alert</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#f0fdf4"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(34,197,94,0.2)"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#10b981,#059669);text-align:center"><div style="font-size:64px;margin-bottom:20px">💰</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">Price Drop!</h1><p style="color:#d1fae5;margin:10px 0 0;font-size:18px">Save big on items you viewed</p></div></td></tr><tr><td style="padding:50px 40px"><p style="color:#1f2937;margin:0 0 30px;font-size:18px;font-weight:600;text-align:center">Great news! Prices have dropped on items you were interested in</p><div style="background:#f0fdf4;padding:35px;border-radius:12px;margin:30px 0"><div style="text-align:center"><p style="margin:0;color:#059669;font-weight:700;font-size:28px">25% OFF</p><p style="margin:10px 0 0;color:#6b7280">Special limited-time pricing</p></div></div><div style="background:#f9fafb;padding:25px;border-radius:8px;margin:25px 0"><p style="margin:0 0 15px;color:#1f2937;font-weight:700">What you'll save:</p><ul style="margin:0;padding-left:22px;color:#6b7280"><li>Exclusive price drop on selected items</li><li>Limited time offer - ends soon</li><li>Free shipping on orders over $50</li><li>Best prices guaranteed</li></ul></div><div style="background:#d1fae5;padding:20px;border-radius:8px;margin:25px 0"><p style="margin:0;color:#065f46;font-size:14px;text-align:center">⏰ Limited Time - Act now before the price goes back up!</p></div><div style="text-align:center;margin-top:40px"><a href="#" style="background:linear-gradient(135deg,#10b981,#059669);color:#fff;text-decoration:none;padding:20px 60px;border-radius:12px;font-weight:900;font-size:20px;display:inline-block;box-shadow:0 8px 20px rgba(16,185,129,0.4)">Shop Sale →</a></div></td></tr></table></body></html>`,
...

  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Unsubscribed</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#f9fafb"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,0.1)"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#6366f1,#4f46e5);text-align:center"><div style="font-size:64px;margin-bottom:20px">✅</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">You're Unsubscribed</h1><p style="color:#c7d2fe;margin:10px 0 0;font-size:18px">Your request has been processed</p></div></td></tr><tr><td style="padding:50px 40px"><p style="color:#1f2937;margin:0 0 30px;font-size:18px;font-weight:600;text-align:center">You've been successfully removed from our mailing list</p><div style="background:#f9fafb;padding:35px;border-radius:12px;margin:30px 0"><div style="text-align:center"><p style="margin:0;color:#6366f1;font-size:20px;line-height:1.8">You won't receive any further marketing emails from us. If you change your mind, you can always resubscribe.</p></div></div><div style="background:#eff6ff;padding:25px;border-radius:8px;margin:25px 0"><p style="margin:0 0 15px;color:#1f2937;font-weight:700">What this means:</p><ul style="margin:0;padding-left:22px;color:#6b7280"><li>No more marketing emails in your inbox</li><li>You can still access your account</li><li>Important transactional emails will still be sent</li><li>You can resubscribe anytime you wish</li></ul></div><p style="color:#6b7280;margin:0 0 30px;line-height:1.7;text-align:center">Thank you for being part of our community. We respect your decision and value your time.</p></td></tr></table></body></html>`,
...

  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Payment Update Needed</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#fef2f2"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(220,38,38,0.2);border:4px solid #dc2626"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#dc2626,#b91c1c);text-align:center"><div style="font-size:64px;margin-bottom:20px">⚠️</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">Action Required</h1><p style="color:#fee2e2;margin:10px 0 0;font-size:18px">Update your payment method to continue</p></div></td></tr><tr><td style="padding:50px 40px"><p style="color:#991b1b;margin:0 0 30px;font-size:20px;font-weight:700;text-align:center">Your payment method failed</p><div style="background:#fef2f2;padding:30px;border-radius:12px;border-left:4px solid #dc2626;margin:30px 0"><p style="margin:0 0 15px;color:#991b1b;font-weight:700;font-size:18px">Issue:</p><p style="margin:0;color:#1f2937;font-size:18px;line-height:1.7">We attempted to process your subscription renewal but couldn't charge your card. Please update your payment method to restore full access to all features.</p></div><div style="background:#f9fafb;padding:25px;border-radius:8px;margin:25px 0"><p style="margin:0 0 15px;color:#1f2937;font-weight:700">What happens if you don't update:</p><ul style="margin:0;padding-left:22px;color:#6b7280"><li>Service will be temporarily suspended</li><li>Your data will be safely stored</li><li>Features will be restored after payment update</li><li>No information will be lost</li></ul></div><div style="background:#dc2626;color:#fff;padding:20px;border-radius:8px;margin:25px 0"><p style="margin:0;font-weight:700;text-align:center">URGENT: Update within 24 hours to avoid service interruption</p></div><div style="text-align:center;margin-top:40px"><a href="#" style="background:linear-gradient(135deg,#dc2626,#b91c1c);color:#fff;text-decoration:none;padding:20px 60px;border-radius:12px;font-weight:900;font-size:20px;display:inline-block;box-shadow:0 8px 20px rgba(220,38,38,0.4)">Update Payment →</a></div></td></tr></table></body></html>`,
