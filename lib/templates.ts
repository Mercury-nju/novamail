...
export const professionalTemplates: ProfessionalTemplate[] = [
  ...
  },
  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Company Announcement</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#fff"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,0.1);border:2px solid #1f2937"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#1f2937,#0f172a);text-align:center"><div style="font-size:64px;margin-bottom:20px">📢</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">COMPANY ANNOUNCEMENT</h1><p style="color:#9ca3af;margin:10px 0 0;font-size:16px">Official Communication</p></div></td></tr><tr><td style="padding:50px 40px"><h2 style="color:#1f2937;margin:0 0 30px;font-size:28px;font-weight:800">Important Notice</h2><div style="background:#f9fafb;padding:30px;border-left:4px solid #1f2937;border-radius:8px;margin:30px 0"><p style="color:#4b5563;margin:0 0 20px;line-height:1.8;font-size:18px">We are pleased to announce a major milestone for our organization. This represents our continued commitment to excellence and innovation.</p></div><div style="background:#eff6ff;padding:25px;border-radius:8px;margin:25px 0"><p style="margin:0 0 15px;color:#1f2937;font-weight:700">What this means for you:</p><ul style="margin:0;padding-left:22px;color:#6b7280;line-height:2"><li>Enhanced products and services</li><li>Improved customer experience</li><li>Expanded market presence</li><li>Continued innovation</li></ul></div><p style="color:#6b7280;margin:0 0 30px;line-height:1.7;text-align:center">For more information, please visit our website or contact our support team.</p><div style="text-align:center;margin-top:40px"><a href="#" style="background:linear-gradient(135deg,#1f2937,#0f172a);color:#fff;text-decoration:none;padding:20px 60px;border-radius:12px;font-weight:900;font-size:20px;display:inline-block;box-shadow:0 8px 20px rgba(31,41,55,0.4)">Learn More →</a></div></td></tr></table></body></html>`,
  ...
  },
  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Abandoned Cart</title></head><body style="margin:0;padding:20px;font-family:'Helvetica Neue',Arial,sans-serif;background:linear-gradient(135deg,#f9fafb,#e5e7eb)"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.1)"><tr><td style="padding:0"><div style="background:linear-gradient(135deg,#f59e0b,#d97706);padding:40px 30px;text-align:center"><div style="font-size:64px;margin-bottom:15px">🛒</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:700">Your Cart is Waiting!</h1><p style="color:#fffbeb;margin:15px 0 0;font-size:16px;font-weight:500">Don't miss out on these items</p></div></td></tr><tr><td style="padding:50px 40px"><h2 style="color:#1f2937;margin:0 0 10px;font-size:22px;font-weight:600">Hi there 👋</h2><p style="color:#6b7280;margin:0 0 35px;line-height:1.8;font-size:15px">We noticed you left some great items in your cart! Complete your purchase now and get FREE shipping on your order.</p><div style="background:#f9fafb;border:2px solid #e5e7eb;padding:30px;border-radius:12px;margin-bottom:35px"><p style="margin:0 0 20px;color:#1f2937;font-weight:700;font-size:16px;text-align:center">📦 Items in Your Cart</p><table width="100%" style="margin-bottom:20px"><tr><td style="padding:15px 0;border-bottom:1px solid #e5e7eb"><div style="display:flex;justify-content:space-between;align-items:center"><div><p style="margin:0;color:#1f2937;font-weight:600">Product Name</p><p style="margin:5px 0 0;color:#6b7280;font-size:14px">Quantity: 1</p></div><p style="margin:0;color:#dc2626;font-weight:bold;font-size:18px">$39.99</p></div></td></tr></table><div style="background:#ecfdf5;border-left:4px solid #10b981;padding:15px;border-radius:8px"><p style="margin:0;color:#059669;font-size:14px;font-weight:600">💰 You saved $10.00</p></div></div><div style="text-align:center"><a href="#" style="background:linear-gradient(135deg,#f59e0b,#d97706);color:#fff;text-decoration:none;padding:18px 50px;border-radius:12px;font-weight:700;font-size:16px;display:inline-block;box-shadow:0 4px 12px rgba(249,115,22,0.3)">Complete Your Purchase →</a><p style="color:#9ca3af;margin:20px 0 0;font-size:13px">Limited time: Free shipping ends in 24 hours</p></div></td></tr><tr><td style="padding:30px 40px;background:#f9fafb;border-top:1px solid #e5e7eb"><p style="margin:0;color:#9ca3af;font-size:12px;text-align:center">Having trouble? Contact our support team at support@example.com</p></td></tr></table></body></html>`,
  ...
  },
  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Product Showcase</title></head><body style="margin:0;padding:20px;font-family:'Helvetica Neue',Arial,sans-serif;background:linear-gradient(135deg,#f9fafb,#f3f4f6)"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:650px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.1)"><tr><td style="padding:0"><div style="background:linear-gradient(135deg,#fbbf24,#f59e0b);padding:60px 40px;text-align:center"><div style="width:180px;height:180px;background:#fff;border-radius:50%;margin:0 auto 30px;display:flex;align-items:center;justify-content:center;box-shadow:0 10px 40px rgba(0,0,0,0.1);font-size:80px">📦</div><h1 style="color:#1f2937;margin:0 0 15px;font-size:38px;font-weight:800">NEW COLLECTION</h1><p style="color:#78350f;margin:0;font-size:18px;font-weight:600">Premium Quality · Exquisite Design</p><div style="background:#1f2937;color:#fbbf24;padding:12px 30px;border-radius:8px;display:inline-block;margin-top:20px;font-size:14px;font-weight:700">LIMITED TIME OFFER</div></div></td></tr><tr><td style="padding:50px 40px"><h2 style="color:#1f2937;margin:0 0 15px;font-size:24px;font-weight:700">Why Choose Our Products?</h2><p style="color:#6b7280;margin:0 0 40px;line-height:1.8;font-size:15px">Discover the perfect blend of quality, innovation, and value that makes us stand out.</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:25px;margin-bottom:40px"><div style="text-align:center;padding:25px;background:#fef3c7;border-radius:12px"><div style="font-size:48px;margin-bottom:15px">⚡</div><h3 style="margin:0 0 8px;color:#1f2937;font-size:16px;font-weight:700">Fast Delivery</h3><p style="margin:0;color:#6b7280;font-size:13px">Free shipping on orders over $50</p></div><div style="text-align:center;padding:25px;background:#dbeafe;border-radius:12px"><div style="font-size:48px;margin-bottom:15px">🔒</div><h3 style="margin:0 0 8px;color:#1f2937;font-size:16px;font-weight:700">Secure Payment</h3><p style="margin:0;color:#6b7280;font-size:13px">100% secure checkout</p></div><div style="text-align:center;padding:25px;background:#d1fae5;border-radius:12px"><div style="font-size:48px;margin-bottom:15px">💯</div><h3 style="margin:0 0 8px;color:#1f2937;font-size:16px;font-weight:700">Quality Guarantee</h3><p style="margin:0;color:#6b7280;font-size:13px">30-day money-back</p></div><div style="text-align:center;padding:25px;background:#fce7f3;border-radius:12px"><div style="font-size:48px;margin-bottom:15px">📞</div><h3 style="margin:0 0 8px;color:#1f2937;font-size:16px;font-weight:700">24/7 Support</h3><p style="margin:0;color:#6b7280;font-size:13px">Always here to help</p></div></div><div style="text-align:center"><a href="#" style="background:linear-gradient(135deg,#fbbf24,#f59e0b);color:#fff;text-decoration:none;padding:20px 50px;border-radius:12px;font-weight:700;font-size:16px;display:inline-block;box-shadow:0 4px 12px rgba(251,191,36,0.3)">Explore Collection →</a></div></td></tr></table></body></html>`,
  ...
  // ========== NEWSLETTER (3 templates) ==========
  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Newsletter</title></head><body style="margin:0;padding:20px;font-family:'Helvetica Neue',Arial,sans-serif;background:#f9fafb"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:650px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08)"><tr><td style="padding:0"><div style="background:linear-gradient(135deg,#1e293b,#475569);padding:50px 40px;text-align:center"><div style="font-size:56px;margin-bottom:20px">📰</div><h1 style="color:#fff;margin:0 0 12px;font-size:36px;font-weight:800">Weekly Newsletter</h1><p style="color:#cbd5e1;margin:0;font-size:17px;font-weight:500">Everything you need to know this week</p></div></td></tr><tr><td style="padding:50px 40px"><h2 style="color:#1f2937;margin:0 0 8px;font-size:24px;font-weight:700;border-bottom:3px solid #3b82f6;padding-bottom:12px">🔥 Top Stories</h2><div style="margin:30px 0;padding:25px;background:linear-gradient(135deg,#eff6ff,#dbeafe);border-radius:12px;border-left:4px solid #3b82f6"><h3 style="margin:0 0 10px;color:#1e40af;font-size:20px;font-weight:700">Breakthrough Innovation in Tech</h3><p style="margin:0 0 15px;color:#1e3a8a;font-size:15px;line-height:1.7">Discover how our latest update is revolutionizing the industry...</p><a href="#" style="color:#2563eb;text-decoration:none;font-weight:600;font-size:14px">Read more →</a></div><div style="margin:30px 0;padding:25px;background:#f9fafb;border-radius:12px"><h3 style="margin:0 0 10px;color:#1f2937;font-size:20px;font-weight:700">📊 Industry Insights</h3><p style="margin:0 0 15px;color:#6b7280;font-size:15px;line-height:1.7">Key trends and statistics shaping the market this week...</p><a href="#" style="color:#2563eb;text-decoration:none;font-weight:600;font-size:14px">View analytics →</a></div><div style="background:linear-gradient(135deg,#7c3aed,#6366f1);padding:30px;border-radius:12px;margin:35px 0;text-align:center"><h3 style="margin:0 0 12px;color:#fff;font-size:22px;font-weight:700">🚀 Exclusive Updates</h3><p style="margin:0 0 25px;color:#e0e7ff;font-size:15px;line-height:1.6">Get early access to our newest features and insights.</p><a href="#" style="background:#fff;color:#7c3aed;text-decoration:none;padding:14px 35px;border-radius:8px;font-weight:700;font-size:15px;display:inline-block">Subscribe Now</a></div></td></tr><tr><td style="padding:30px 40px;background:#f9fafb;border-top:2px solid #e5e7eb"><div style="text-align:center"><p style="margin:0 0 20px;color:#6b7280;font-size:14px;font-weight:600">Quick Links</p><table width="100%"><tr><td style="text-align:center;padding:0 15px"><a href="#" style="color:#3b82f6;text-decoration:none;font-size:14px;font-weight:600">Archive</a></td><td style="text-align:center;padding:0 15px"><a href="#" style="color:#3b82f6;text-decoration:none;font-size:14px;font-weight:600">Resources</a></td><td style="text-align:center;padding:0 15px"><a href="#" style="color:#3b82f6;text-decoration:none;font-size:14px;font-weight:600">Contact</a></td></tr></table></div></td></tr></table></body></html>`,
  ...
  },
  {
    ...
    htmlContent: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Payment Receipt</title></head><body style="margin:0;padding:20px;font-family:Arial,sans-serif;background:#f0f9ff"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(59,130,246,0.2)"><tr><td style="padding:50px 40px;background:linear-gradient(135deg,#3b82f6,#2563eb);text-align:center"><div style="font-size:64px;margin-bottom:20px">✓</div><h1 style="color:#fff;margin:0;font-size:32px;font-weight:800">Payment Receipt</h1><p style="color:#bfdbfe;margin:10px 0 0;font-size:18px">Your payment has been processed</p></div></td></tr><tr><td style="padding:50px 40px"><p style="color:#1f2937;margin:0 0 30px;font-size:18px;font-weight:600;text-align:center">Thank you for your payment!</p><div style="background:#eff6ff;padding:35px;border-radius:12px;border:2px solid #bfdbfe;margin:30px 0"><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding:15px 0;border-bottom:2px solid #cbd5e1"><div style="display:flex;justify-content:space-between"><span style="color:#1f2937;font-weight:700">Receipt Number:</span><span style="color:#2563eb;font-weight:900;font-size:20px">#12345</span></div></td></tr><tr><td style="padding:15px 0;border-bottom:2px solid #cbd5e1"><div style="display:flex;justify-content:space-between"><span style="color:#1f2937;font-weight:700">Payment Date:</span><span style="color:#1f2937;font-weight:600">March 15, 2024</span></div></td></tr><tr><td style="padding:15px 0"><div style="display:flex;justify-content:space-between"><span style="color:#1f2937;font-weight:700">Amount Paid:</span><span style="color:#16a34a;font-weight:900;font-size:24px">$99.99</span></div></td></tr></table></div><div style="background:#f9fafb;padding:25px;border-radius:8px;margin:25px 0"><p style="margin:0;color:#6b7280;text-align:center">This receipt has been automatically saved to your account and is also available for download.</p></div><div style="text-align:center;margin-top:40px"><a href="#" style="background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;text-decoration:none;padding:20px 60px;border-radius:12px;font-weight:900;font-size:20px;display:inline-block;box-shadow:0 8px 20px rgba(59,130,246,0.4)">Download Receipt →</a></div></td></tr></table></body></html>`,
