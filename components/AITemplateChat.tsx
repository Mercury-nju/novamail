...
export default function AITemplateChat() {
  ...
  return (
    <div className="h-full flex bg-white">
      ...
      <div className={`${showSidebar ? 'w-64' : 'w-0'} transition-all duration-300 border-r border-gray-200 overflow-hidden flex flex-col`}>
        <div className="flex-1 overflow-y-auto p-4">
          <button
            onClick={handleNewChat}
            className="w-full mb-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center justify-center space-x-2"
          >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="ml-2 p-1 text-red-600 hover:bg-red-50 rounded opacity-0 group-hover:opacity-100"
                    >
