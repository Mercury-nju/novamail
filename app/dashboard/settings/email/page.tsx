...
export default function EmailSettingsPage() {
  ...
  const loadEmailConfig = async () => {
    try {
      ...
      const response = await fetch(`https://novamail.world/api/user/email-config?userId=${encodeURIComponent(userId)}`)
      if (response.ok) {
  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      const response = await fetch('https://novamail.world/api/user/test-email', {
        method: 'POST',
        headers: {
  ...
  const handleSaveConfig = async () => {
    ...
    try {
      ...
      const response = await fetch('https://novamail.world/api/user/email-config', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
