  ...
  const plans = [
    {
      ...
      features: [
        ...
        'Basic email templates (5 templates)',
        '100 contacts',
    ...
    },
    {
      id: 'premium',
      name: 'Premium',
      description: 'AI-powered email marketing for growing businesses',
      monthlyPrice: 19,
      yearlyPrice: 190,
      features: [
        '500 credits per month (100 emails)',
        '🤖 AI Email Assistant & Content Generation',
        '📧 Smart Email Templates (50+ templates)',
